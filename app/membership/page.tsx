    ...
    <div className="min-h-screen bg-earth-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-2xl mx-auto">
          ...
          >
            <h3 className="text-2xl font-bold text-earth-800 mb-2">Monthly</h3>
            <div className="mb-6">
              <span className="text-4xl font-bold text-gold-600">$1</span>
              <span className="text-earth-600 ml-2">/month</span>
            </div>
            <button
              disabled
            ...
            <p className="text-xs text-earth-500 text-center mb-6">Stripe integration coming soon</p>
            <ul className="space-y-3">
              {features.map((feature) => (
                <li key={feature} className="flex items-start text-earth-600">
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-earth-800 mb-2">Annual</h3>
            <div className="mb-6">
              <span className="text-4xl font-bold text-gold-600">$10</span>
              <span className="text-earth-600 ml-2">/year</span>
            </div>
            <button
              disabled
        ...
        {/* Cancellation Note */}
        <div className="max-w-2xl mx-auto bg-earth-100 border-2 border-earth-300 rounded-lg p-6 mb-8">
          <p className="text-earth-800 text-center">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-earth-600 mb-4">Already a member?</p>
