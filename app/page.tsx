      ...
      <section className="hero-gradient text-earth-50 py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="w-36 h-36 mx-auto mb-8 flex items-center justify-center relative">
            <div className="absolute z-0" style={{width: '240px', height: '170px', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'radial-gradient(ellipse at center, rgba(0,0,0,0.55) 0%, rgba(0,0,0,0.3) 45%, transparent 70%)', pointerEvents: 'none'}}></div>
