      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section className="bg-white border-2 border-earth-300 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 mb-4">From Pan to Sluice</h2>
          ...
          {/* Adding Power */}
          <section className="bg-white border-2 border-earth-300 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 mb-4">Adding Power</h2>
            <p className="text-earth-600 leading-relaxed">
          ...
          {/* Equipment Financing */}
          <section className="bg-white border-2 border-earth-300 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 mb-4">Equipment Financing</h2>
            <p className="text-earth-600 leading-relaxed">
          ...
          {/* Permits & Compliance */}
          <section className="bg-white border-2 border-earth-300 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 mb-4">Permits & Compliance</h2>
            <p className="text-earth-600 leading-relaxed">
