      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <section className="bg-white dark:bg-dark-surface border-2 border-earth-300 dark:border-earth-700 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 dark:text-dark-text mb-4">What is a Mining Claim?</h2>
          ...
          {/* Types of Claims */}
          <section className="bg-white dark:bg-dark-surface border-2 border-earth-300 dark:border-earth-700 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 dark:text-dark-text mb-4">Types of Claims</h2>
            <p className="text-earth-600 dark:text-earth-300 leading-relaxed">
          ...
          {/* Where to Search */}
          <section className="bg-white dark:bg-dark-surface border-2 border-earth-300 dark:border-earth-700 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 dark:text-dark-text mb-4">Where to Search</h2>
            <p className="text-earth-600 dark:text-earth-300 leading-relaxed">
          ...
          {/* How to File */}
          <section className="bg-white dark:bg-dark-surface border-2 border-earth-300 dark:border-earth-700 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-earth-800 dark:text-dark-text mb-4">How to File</h2>
            <p className="text-earth-600 dark:text-earth-300 leading-relaxed">
