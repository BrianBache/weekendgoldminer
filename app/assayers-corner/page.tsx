...
export default function AssayersCorner() {
  ...
  return (
    <div className="min-h-screen bg-earth-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-earth-800 to-earth-700 text-white py-16">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <Link href="/assayers-corner/gold-value-tool">
            <div className="bg-white border-2 border-gold-300 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-gold-600 text-3xl mb-3">🔍</div>
              <h2 className="text-xl font-bold text-earth-800 mb-2">Gold Value Tool</h2>
          ...
          <Link href="/assayers-corner/sell-your-gold">
            <div className="bg-white border-2 border-gold-300 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-gold-600 text-3xl mb-3">📋</div>
              <h2 className="text-xl font-bold text-earth-800 mb-2">Sell Your Gold Directory</h2>
              <p className="text-earth-600">
          ...
          <Link href="/assayers-corner/diy-smelting">
            <div className="bg-white border-2 border-gold-300 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-gold-600 text-3xl mb-3">🔥</div>
              <h2 className="text-xl font-bold text-earth-800 mb-2">DIY Smelting</h2>
              <p className="text-earth-600">
        ...
        {/* Articles Section */}
        <div>
          <h2 className="text-3xl font-bold text-earth-800 mb-8">Latest Articles</h2>
          <div className="grid grid-cols-1 gap-6">
            {articles.map((article) => (
              <article
                key={article.id}
                className="bg-white rounded-lg shadow p-8 border-l-4 border-gold-500 hover:shadow-lg transition-shadow"
              >
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-2xl font-bold text-earth-800">{article.title}</h3>
                  <span className="text-sm text-earth-500">{article.date}</span>
                </div>
                <p className="text-earth-600 text-lg">{article.excerpt}</p>
