  ...
  return (
    <div className="min-h-screen bg-earth-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        {/* Mission Statement */}
        <section className="mb-12 bg-white border-2 border-earth-300 rounded-lg p-8">
          <h2 className="text-2xl font-bold text-earth-800 mb-4">Our Mission</h2>
        ...
        <section className="mb-12 max-w-2xl mx-auto">
          <h2 className="text-2xl font-bold text-earth-800 mb-6">Get in Touch</h2>
          <div className="bg-white border-2 border-earth-300 rounded-lg p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border-2 border-earth-300 rounded-lg focus:outline-none focus:border-gold-400 text-earth-800"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full px-4 py-2 border-2 border-earth-300 rounded-lg focus:outline-none focus:border-gold-400 text-earth-800 resize-none"
                ></textarea>
              </div>
        ...
        {/* Legal Disclaimers */}
        <section className="bg-earth-100 border-2 border-earth-300 rounded-lg p-8">
          <h2 className="text-2xl font-bold text-earth-800 mb-4">Legal Disclaimer</h2>
